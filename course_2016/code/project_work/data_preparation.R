...
start.v <- which(text.v == “”）
end.v <- which(text.v == '*** END OF THIS PROJECT GUTENBERG EBOOK The Life and Adventures of Santa Claus ***')
...
books.cor <- tm_map(books.cor, stemDocument, lazy = TRUE)
books.cor <- tm_map(books.cor, stripWhitespace, lazy = TRUE)
