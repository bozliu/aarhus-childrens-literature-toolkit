...
dir.create(dd)
# download file
filename.v = paste(dd,'/pg520.txt',sep="")
if (!file.exists(filename.v)) { download.file('http://www.gutenberg.org/cache/epub/520/pg520.txt', destfile = filename.v) }
# import text lines
...
start.v <- which(text.v == '*** START OF THIS PROJECT GUTENBERG EBOOK LIFE, ADVENTURES OF SANTA CLAUS ***')
end.v <- which(text.v == '*** START OF THIS PROJECT GUTENBERG EBOOK LIFE, ADVENTURES OF SANTA CLAUS ***')
